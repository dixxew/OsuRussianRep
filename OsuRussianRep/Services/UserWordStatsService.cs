...
public sealed class UserWordStatsService(AppDbContext db) : IUserWordStatsService
{
    ...
    {
        "я", "ты", "он", "она", "мы", "вы", "они", "как", "это", "что", 
        "в", "во", "на", "по", "из", "и", "или", "а", "но", "же", "то",
        "к", "с", "у", "о", "об", "от", "до", "за", "для", "под", "там",
        "osu", "pp", "https", "http", "twitch", "discord", "sh",  "ещё",
        "com", "ru", "org", "net", "youtu", "youtube", "ss", "так", "да",
        "www", "ppy", "osu.ppy", "osu.ppy.sh", "мне", "ну", "меня", "live", "65535", "io",
        "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "staticflickr", "jpg", "png", 
